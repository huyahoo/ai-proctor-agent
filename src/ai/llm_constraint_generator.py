...
class LLMConstraintGenerator:
    ...
    def _build_prompt(self, event_data: dict) -> str:
        ...
        base_prompt = (
            ...
            "**Instruction for VLM:**\n"
            "Verify if the student ID 1 in the 'White T-shirt' continues to look at the 'Red sweater' student's exam paper. Track head and eye movements to determine if they are copying.\n\n"
            "---\n\n"
            ...
            "**Instruction for VLM:**\n"
            "Closely monitor the student ID 5 in the 'Green hoodie'. Determine if they are interacting with unauthorized items like a phone or notes under the desk. "
            ...
            "**Instruction for VLM:**\n"
            "Focus on the student ID 2 in the 'Grey sweatshirt'. Observe their arm and hand movements to determine if they are passing an object to another student.\n\n"
            "--- TASK ---\n"
        )
