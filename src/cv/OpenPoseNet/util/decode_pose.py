...
def decode_pose(img_orig, heatmaps, pafs):
    ...
    # print("HAHAHA: ", joint_list_per_joint_type)
    ...
    # print("KEKEKE: ", joint_list.tolist(), len(joint_list), len(joint_list[0]), type(joint_list))
    ...
    # print("SAME PERSON: ", connected_limbs)
    ...
    # print("SAME PERSON AGAIN: ", person_to_joint_assoc.tolist())
